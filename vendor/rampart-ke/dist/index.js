...
import { KenyanEntityTable } from "./session.js";
...
export class KenyanGuard {
    ...
    table;
    recognizers;
    constructor(guard, table, recognizers) {
        this.guard = guard;
        this.table = table;
...
export async function createKenyanGuard(options) {
 ...
 */
export async function protectKE(text, options) {
    if (!sharedGuard)
        sharedGuard = KenyanGuard.create(options);
