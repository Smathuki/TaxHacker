 ...
 */
const NAME_CUE = /\b(?:[Jj]ina\s+langu\s+ni|[Jj]ina\s+lake\s+ni|[Jj]ina\s+ni|[Nn]inaitwa|[Nn]aitwa|[Aa]naitwa|[Mm]imi\s+ni|[Mm]y\s+name\s+is)\s+([A-Z][a-zA-Z'’]+(?:\s+[A-Z][a-zA-Z'’]+)?)/gd;
export const swahiliNameRecognizer = {
    label: "NAME_KE",
    priority: 70,
    detect(text) {
...
//# sourceMappingURL=swahiliName.js.map