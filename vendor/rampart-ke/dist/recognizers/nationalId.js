 ...
 */
const NATIONAL_ID = /\b(?:national\s+id|id(?:\s*(?:no\.?|number|#|card))?|kitambulisho)\b\D{0,8}(\d{7,8})\b/gid;
/** Maisha Namba: the unique personal identifier rolled out from 2023/2024. */
const MAISHA = /\bmaisha\s+namba\b\D{0,10}(\d{8,12})\b/gid;
export const nationalIdRecognizer = {
    label: "NATIONAL_ID",
    priority: 80,
    detect(text) {
...
export const maishaNambaRecognizer = {
    label: "MAISHA_NAMBA",
    priority: 82,
    detect(text) {
